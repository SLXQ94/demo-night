  ...
  return (
    <section
            ...
            <div className="container">
                {/* <div className="flex items-center">
                    <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
                        <div className="mb-10">
                            <img src="/images/trial_visible.png" alt="logo" width={160} height={55} />
                        </div>

                        <p className="body-1 mb-10 max-w-md">
                            Try it now for free on iOS, Android, PC, Web - whatever
                            your flavor, we've got you covered.
                        </p>
        ...
        <h2 className="font-palanquin text-4xl font-bold">
          Trusted by over   
          <span className="text-p3"> 1,000+ Businesses</span><br />
          {/* <span className="text-p3"> the Legal Burden</span> onto us */}
        </h2>
            {/* <div className="sm:flex-wrap"> */}
                <ul className="mt-24 flex flex-wrap justify-center gap-4">
