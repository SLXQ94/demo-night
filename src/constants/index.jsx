export const features = [
  ...
  export const details = [
    {
      id: '0',
      icon: 3698,
      title: 'Claims under management',
    },
    {
      id: '1',
      icon: 106941,
      title: 'Disputes Funded',
    },
    {
      id: '2',
      icon: 1042,
  ...
  export const testimonials = [
    {
      ...
      avatarUrl: `${import.meta.env.BASE_URL}/images/testimonials/chirag_goyal.jpg`,
      comment:
        "I am marwari baniya Indian, I know how to maintain business relationships and how it helps us to grow because i have seen these things from my childhood. I am funny and stress free guy, I don't take stress and not like those people who give me stress. I am simple guy, just looking for someone with whom I can build something.",
    },
    {
      id: '1',
      name: 'Chirag Goyal',
      role: 'Chartered Accountant',
      avatarUrl: `${import.meta.env.BASE_URL}/images/testimonials/chirag-goyal.jpg`,
      comment:
        "Currently, we are acting as Mutual fund distributor but soon we are targeting newer alternative securities for retail investors such as Bonds, SM REIT, Digital GOLD and silver etc. We are planning to create AI based portfolio for retail investors which is tax optimized provided their risk tolerance, behavior and expectation.",
    },
    {
      id: '2',
      name: 'Priyanshu Goyal',
      role: 'Chartered Accountant',
      avatarUrl: `${import.meta.env.BASE_URL}/images/testimonials/priyanshu_goyal.jpg`,
      comment:
        "We are working on it past 3 months, we have accumulated good AUM, we also have registered our name with AMFI and SEBI. As, it is heavily regulated market, we are following every rules and regulation provided. We have also hired social marketing interns and writers for the same, now we are targeting GEN-Zs.",
    },
  ];
  ...
  export const socials = [
    ...
    //   id: '1',
    //   title: 'Facebook',
    //   icon: `${import.meta.env.BASE_URL}/images/socials/facebook.svg`,
    //   url: '#',
    // },
    // {
    //   id: '2',
    //   title: 'Twitter',
    //   icon: `${import.meta.env.BASE_URL}/images/socials/twitter.svg`,
    //   url: '#',
    // },
    {
      id: '1',
      title: 'LinkedIn',
      icon: `${import.meta.env.BASE_URL}/images/socials/linkedin.svg`,
      url: 'https://www.linkedin.com/company/trialvest/',
    },
    {
      id: '2',
      title: 'YouTube',
      icon: `${import.meta.env.BASE_URL}/images/socials/youtube.svg`,
      url: 'https://www.youtube.com/@minvisk',
    },
  ];
  ...
  export const footerLinks = [
    ...
    },
    {
      ...
      links: [
        {name: "NDM-2, NSP, Pitampura, Delhi-85", link: "https://maps.app.goo.gl/TxxJfsTe7uRxCcFF9"}
      ],
    },
    {
        title: "Contact",
        links: [
            { name: "trialvestinfo@gmail.com", link: "mailto:trialvestinfo@gmail.com" },
            { name: "+91 81785 07328", link: "tel:+918178507328" },
        ],
    },
];